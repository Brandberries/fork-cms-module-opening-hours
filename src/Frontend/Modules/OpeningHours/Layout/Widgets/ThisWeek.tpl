...
{option:days}
	...
	<table>
		...
		{iteration:days}
			<tr {option:days.today}class="today"{/option:days.today}>
				<th>{$days.dayName}</th>
				...
				{option:days.closedExtraordinary}
					<td colspan="{option:partOneAndTwo}5{/option:partOneAndTwo}{option:!partOneAndTwo}2{/option:!partOneAndTwo}">{$msgClosedExtraordinaryShort}</td>
				{/option:days.closedExtraordinary}
